...
import com.kmwllc.brigade.interfaces.DocumentConnector2;
 ...
 * service.
 */
public abstract class AbstractConnector2 implements DocumentConnector2 {

    public final static Logger log = LoggerFactory.getLogger(AbstractConnector2.class.getCanonicalName());
    ...
    protected WorkflowServer2 workflowServer = WorkflowServer2.getInstance();
    ...
    public AbstractConnector2() {
    }

    public abstract void setConfig(ConnectorConfig2 config);
    ...
    @Override
    public void setWorkflowServer(WorkflowServer2 workflowServer) {
