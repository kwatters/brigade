...
public class CSVConnector2 extends AbstractConnector2 {

  public final static Logger log = LoggerFactory.getLogger(CSVConnector2.class.getCanonicalName());
  ...
  public CSVConnector2() {
    super();
  }

  @Override
  public void setConfig(ConnectorConfig2 config) {
