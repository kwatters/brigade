 ...
 *
 */
public abstract class AbstractStage2 {
  
  // TODO: make sure the subclasses get the right logger..
  public final static Logger log = LoggerFactory.getLogger(AbstractStage2.class.getCanonicalName());
  ...
  public abstract void startStage(StageConfig2 config);
